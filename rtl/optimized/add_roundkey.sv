 ...
 *   This module is reused unchanged in the optimized design.
 *   AddRoundKey is already a simple XOR operation, so reducing it
 *   further would provide only minor area savings while increasing
 *   controller complexity and encryption latency.
 *
 * Hardware meaning:
 ...
 *
 * Reusability:
 *   - Used in the baseline one-round-per-cycle AES design.
 *   - Reused in the optimized shared-resource AES design.
 * ============================================================
 */
