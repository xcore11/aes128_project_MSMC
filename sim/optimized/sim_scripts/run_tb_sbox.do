# Auto-generated ModelSim script for tb_sbox optimized
...
echo "=============================================="
echo "RUNNING tb_sbox (optimized)"
...
set tb_file "../../tb/optimized/tb_sbox.sv"
...
vsim -wlf "waveforms/tb_sbox.wlf" work.tb_sbox
view wave
add wave -divider "tb_sbox"
add wave -r sim:/tb_sbox/*

set raw_log   "work/tmp_logs/tb_sbox_raw_log.txt"
set clean_log "logs/tb_sbox_log.txt"
...
echo "Waveform saved to: [file normalize waveforms/tb_sbox.wlf]"
