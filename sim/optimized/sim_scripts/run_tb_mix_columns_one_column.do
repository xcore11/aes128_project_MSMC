# Auto-generated ModelSim script for tb_mix_columns_one_column optimized
...
echo "=============================================="
echo "RUNNING tb_mix_columns_one_column (optimized)"
...
set tb_file "../../tb/optimized/tb_mix_columns_one_column.sv"
...
vsim -wlf "waveforms/tb_mix_columns_one_column.wlf" work.tb_mix_columns_one_column
view wave
add wave -divider "tb_mix_columns_one_column"
add wave -r sim:/tb_mix_columns_one_column/*

set raw_log   "work/tmp_logs/tb_mix_columns_one_column_raw_log.txt"
set clean_log "logs/tb_mix_columns_one_column_log.txt"
...
echo "Waveform saved to: [file normalize waveforms/tb_mix_columns_one_column.wlf]"
