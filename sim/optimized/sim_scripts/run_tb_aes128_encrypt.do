# Auto-generated ModelSim script for tb_aes128_encrypt optimized
...
echo "=============================================="
echo "RUNNING tb_aes128_encrypt (optimized)"
...
set tb_file "../../tb/optimized/tb_aes128_encrypt.sv"
...
vsim -wlf "waveforms/tb_aes128_encrypt.wlf" work.tb_aes128_encrypt
view wave
add wave -divider "tb_aes128_encrypt"
add wave -r sim:/tb_aes128_encrypt/*

set raw_log   "work/tmp_logs/tb_aes128_encrypt_raw_log.txt"
set clean_log "logs/tb_aes128_encrypt_log.txt"
...
echo "Waveform saved to: [file normalize waveforms/tb_aes128_encrypt.wlf]"
