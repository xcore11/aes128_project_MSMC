# Auto-generated ModelSim script for tb_key_expansion (baseline)
...
echo "=============================================="
echo "RUNNING tb_key_expansion (baseline)"
...
set tb_file "../../tb/baseline/tb_key_expansion.sv"
...
vsim -wlf "waveforms/tb_key_expansion.wlf" work.tb_key_expansion

view wave
add wave -divider "tb_key_expansion"
...
set log_file "logs/tb_key_expansion_log.txt"
