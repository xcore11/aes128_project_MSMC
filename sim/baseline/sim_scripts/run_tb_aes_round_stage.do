# Auto-generated ModelSim script for tb_aes_round_stage (baseline)
...
echo "=============================================="
echo "RUNNING tb_aes_round_stage (baseline)"
...
set tb_file "../../tb/baseline/tb_aes_round_stage.sv"
...
vsim -wlf "waveforms/tb_aes_round_stage.wlf" work.tb_aes_round_stage

view wave
add wave -divider "tb_aes_round_stage"
...
set log_file "logs/tb_aes_round_stage_log.txt"
