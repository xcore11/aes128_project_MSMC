# Auto-generated ModelSim script for tb_sub_bytes (baseline)
...
echo "=============================================="
echo "RUNNING tb_sub_bytes (baseline)"
...
set tb_file "../../tb/baseline/tb_sub_bytes.sv"
...
vsim -wlf "waveforms/tb_sub_bytes.wlf" work.tb_sub_bytes

view wave
add wave -divider "tb_sub_bytes"
...
set log_file "logs/tb_sub_bytes_log.txt"
