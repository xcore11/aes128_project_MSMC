# Auto-generated ModelSim script for tb_add_roundkey (baseline)
...
echo "=============================================="
echo "RUNNING tb_add_roundkey (baseline)"
...
set tb_file "../../tb/baseline/tb_add_roundkey.sv"
...
vsim -wlf "waveforms/tb_add_roundkey.wlf" work.tb_add_roundkey

view wave
add wave -divider "tb_add_roundkey"
...
set log_file "logs/tb_add_roundkey_log.txt"
